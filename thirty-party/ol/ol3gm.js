...
(function (root, factory) {
    ...
    var v = [156543.03390625, 78271.516953125, 39135.7584765625, 19567.87923828125, 9783.939619140625, 4891.9698095703125, 2445.9849047851562, 1222.9924523925781, 611.4962261962891, 305.74811309814453, 152.87405654907226, 76.43702827453613, 38.218514137268066, 19.109257068634033, 9.554628534317017, 4.777314267158508, 2.388657133579254, 1.194328566789627, .5971642833948135, .298582141697, .14929107084, .07464553542, .03732276771];
    ...
    function D(a, b) {
        a.forEach(ol.Observable.unByKey);
        a.length = 0;
        b && (b.forEach(E), b.length = 0)
    }
    function F(a) {
    ...
    window.google && window.google.maps && r(F, google.maps.OverlayView);
    g = F.prototype;
    g.J = !1;
    g.L = 0;
    g.U = 0;
    g.changed = function (a) {
        switch (a) {
            case "fontColor":
            case "fontFamily":
            case "fontSize":
    ...
    g.S = function (a) {
        var b = this.e, c = this.a, d = this.i;
        this.b.push(a);
        b = new I(b, c, a, d, this.b.indexOf(a));
        b.g();
        this.d.push({feature: a, r: b})
    };
    g.Q = function (a) {
        a = this.b.indexOf(a);
        -1 !== a && (this.b.splice(a, 1), this.d[a].r.f(), this.d.splice(a, 1))
    };
    ...
    var ja = -1 != L.indexOf("Opera") || -1 != L.indexOf("OPR"), M = -1 != L.indexOf("Trident") || -1 != L.indexOf("MSIE"), N = -1 != L.indexOf("Gecko") && -1 == L.toLowerCase().indexOf("webkit") && !(-1 != L.indexOf("Trident") || -1 != L.indexOf("MSIE")), O = -1 != L.toLowerCase().indexOf("webkit");
    function ka() {
        var a = l.document;
    ...
    var na = l.document, oa = na && M ? ka() || ("CSS1Compat" == na.compatMode ? parseInt(la, 10) : 5) : void 0;
    var Q;
    (Q = !M) || (Q = M && 9 <= oa);
    var pa = Q, qa = M && !P("9");
    !O || P("528");
    N && P("1.9b") || M && P("8") || ja && P("9.5") || O && P("528");
    N && !P("8") || M && P("9");
    function R(a, b) {
        this.type = a;
        this.a = this.b = b
    ...
    var U = "closure_lm_" + (1E6 * Math.random() | 0), V = {}, wa = 0;
    ...
    function ya(a) {
        return "function" == m(a) ? a : a[Ea] || (a[Ea] = function (b) {
    ...
    g.g = function () {
        X.j.g.call(this);
        var a = this.e.getView(), b = this.h;
        b.push(a.on("change:center", this.u, this));
        b.push(a.on("change:resolution", this.H, this));
        this.M.push(xa(window, "resize", this.ba, !1, this));
        this.u();
        this.H()
    };
    g.f = function () {
    ...
    g.u = function () {
        var a = this.e.getView(), b = a.getProjection(), a = a.getCenter();
        "array" == m(a) && (a = ol.proj.transform(a, b, "EPSG:4326"), this.a.setCenter(new google.maps.LatLng(a[1], a[0])))
    };
